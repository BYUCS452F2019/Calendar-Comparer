...
delete from calendar_membership;

delete from event;

delete from group_calendar;

delete from group_connection;
...
--emily events
insert into event (event_personal_calendar_id, event_name, event_start, event_end) 
values ('f7f6cea9-85f3-4e2e-bc40-0e9617ca2b44', 'test', '10-20-2019 7:00:00','10-20-2019 10:00:00');
;
insert into event (event_personal_calendar_id, event_name, event_start, event_end) 
values ('f7f6cea9-85f3-4e2e-bc40-0e9617ca2b44', 'test', '10-20-2019 15:00:00','10-20-2019 18:00:00');
;
--jared events
insert into event (event_personal_calendar_id, event_name, event_start, event_end) 
values ('f7f6cea9-85f3-4e2e-bc40-0e9617ca2b45','test', '10-20-2019 7:00:00','10-20-2019 10:00:00');
;
insert into event (event_personal_calendar_id, event_name, event_start, event_end) 
values ('f7f6cea9-85f3-4e2e-bc40-0e9617ca2b45','test', '10-20-2019 11:00:00','10-20-2019 13:00:00');